                ...
                <Form.Group className="mb-3 text-start">
                  ...
                  <div className="position-relative">
                    <Form.Control
                      ...
                      className="bg-slate-50 border-0 py-2 shadow-none rounded-lg"
                      placeholder="Enter new password"
                    />
                  </div>
                  <Form.Text className="text-muted" style={{ fontSize: '10px' }}>Min. 8 characters</Form.Text>
                </Form.Group>
            ...
            <Form onSubmit={handleUpdatePersonal} className="h-100 flex flex-col">
              ...
              <Card.Body className="p-4 pt-0">
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        value={formData.name}
                        onChange={handleChange}
                        className="bg-slate-50 border-0 py-2 px-3 shadow-none rounded-lg"
                        required
                      />
                    </Form.Group>
                  </Col>
                ...
                <Row className="g-4 text-start">
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <div className="bg-slate-100 text-slate-500 py-2 px-3 rounded-lg border border-slate-200 small font-bold uppercase tracking-wider">
                        {formData.role}
                      </div>
                    </Form.Group>
                  </Col>
                ...
                <div className="mt-5 p-4 bg-slate-50 rounded-xl border border-slate-100">
                  <h6 className="fw-bold text-slate-800 mb-3 small uppercase tracking-wide">Communication Preferences</h6>
                  <div className="space-y-3">
                    <Form.Check
                      type="switch"
                      id="email-notif-staff"
                      label="Enable desktop notifications for new orders"
                      defaultChecked
                    ...
                    <Form.Check
                      type="switch"
                      id="sms-notif-staff"
                      label="Receive daily summary reports via email"
                      className="text-slate-600 font-medium"
                    />
                  </div>
                </div>
