            ...
            <body>
                ...
                <div class="info-grid">
                    <div>
                        ...
                        ${order.shippingAddress?.address || '123, Green Park Avenue,'}<br>
                        ${order.shippingAddress?.city || 'Mumbai'}, ${order.shippingAddress?.state || 'Maharashtra'} - ${order.shippingAddress?.zipCode || '400001'}
                    </div>
                    <div>
                                    ...
                                    <tr key={idx}>
                                        <td className="px-5 py-3 pl-6">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="font-medium text-gray-800">{item.product?.name || item.name}</div>
                                                    <div className="text-xs text-gray-500">Variation: Standard</div>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div className="flex justify-end">
                        <div className="w-full max-w-xs space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="text-gray-900 font-medium">{displayTotal}</span>
                            </div>
                            <div className="flex justify-between text-sm">
