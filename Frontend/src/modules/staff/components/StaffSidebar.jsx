...
const StaffSidebar = ({ showMobile, onClose }) => {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 h-full w-[260px] bg-slate-900 text-slate-200 overflow-y-auto z-[1050] transition-transform duration-300 ease-in-out 
            ...
            >
                <div className="h-[60px] flex items-center px-6 font-bold text-xl border-b border-white/10 text-white">
                    <Icons.Briefcase className="mr-2 text-green-500" size={24} />
                                    ...
                                    {item.submenu ? (
                                        ...
                                        <NavLink
                                            ...
                                            className={({ isActive }) =>
                                                ...
                                                ${isActive ? 'bg-green-600 text-white font-medium shadow-md' : 'text-slate-400 hover:bg-white/5 hover:text-white'}`
                                            }
                                            onClick={() => showMobile && onClose()}
                                        >
                                            {renderIcon(item.icon)}
