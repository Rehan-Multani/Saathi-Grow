...
const CategoryBrandStrip = ({ section, accentColor = '#0c831f' }) => {
  ...
  return (
    <section className="category-landing-section space-y-2.5 sm:space-y-3">
      ...
      <div className="category-landing-scroll category-landing-brand-strip flex gap-3 overflow-x-auto pb-4 scrollbar-hide lg-scrollbar-show -mx-3 px-3 sm:mx-0 sm:px-0">
