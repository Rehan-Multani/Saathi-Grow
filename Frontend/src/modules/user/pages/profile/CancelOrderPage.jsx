    ...
    if (submitted) {
        return (
            <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col items-center justify-center p-6 text-center">
                ...
                <h2 className="text-[17px] font-black text-gray-900 dark:text-gray-100 mb-2 tracking-tight">Order cancelled!</h2>
                <p className="text-[11px] text-gray-500 mb-8 max-w-[250px]">Your order #{id} has been successfully cancelled. Your refund will be processed shortly.</p>
            ...
            <div className="sticky top-0 z-40 bg-white/80 dark:bg-black/60 backdrop-blur-md border-b border-gray-100 dark:border-white/5 p-4 transition-colors">
                <div className="max-w-2xl mx-auto flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-[13.5px] font-black text-gray-900 dark:text-gray-100 tracking-tight leading-none">Cancel order</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-2xl mx-auto px-4 py-8 animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="space-y-6">
                    <div className="bg-red-50 dark:bg-red-500/5 p-4 rounded-2xl border border-red-100 dark:border-red-500/10 mb-2">
                        <p className="text-[10px] text-red-600 font-bold tracking-tight">Are you sure you want to cancel? This action cannot be undone.</p>
                    </div>

                    <div>
                        <p className="!text-[8px] font-black text-gray-400 tracking-[0.2em] mb-4 px-1 uppercase">Select reason for cancellation</p>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full h-28 p-3.5 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-xl focus:outline-none focus:ring-1 focus:ring-red-600 text-[11px] dark:text-white placeholder:text-gray-400 shadow-sm"
                        />
                    </div>
