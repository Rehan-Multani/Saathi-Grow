        ...
        <div className="min-h-screen bg-transparent dark:bg-[#0a0a0a] transition-colors duration-300 pb-24">
            ...
            <div className="sticky top-0 z-40 bg-white/80 dark:bg-black/60 backdrop-blur-md border-b border-gray-100 dark:border-white/5 p-4">
                <div className="max-w-2xl mx-auto flex items-center gap-4">
                    ...
                    <div>
                        <div className="!text-[11.5px] font-black text-gray-900 dark:text-gray-100 tracking-tight leading-none mb-1">Order Summary</div>
                        <p className="!text-[7.5px] text-gray-400 font-bold tracking-widest uppercase">#{order.id} • {order.date}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-2xl mx-auto px-2 py-4">
                ...
                <div className="bg-gray-50 dark:bg-white/5 rounded-xl p-3 mb-6 border border-gray-100 dark:border-white/10 shadow-sm overflow-hidden">
                    <div className="flex items-center justify-between relative text-center">
                        ...
                        <div className="flex flex-col items-center gap-1 z-10 relative">
                            ...
                            <span className="text-[7px] font-black text-gray-400 uppercase tracking-tight">Placed</span>
                        </div>
                        <div className="flex flex-col items-center gap-1 z-10 relative">
                            ...
                            <span className="text-[7px] font-black text-gray-400 uppercase tracking-tight">Shipped</span>
                        </div>
                        <div className="flex flex-col items-center gap-1 z-10 relative">
                            ...
                            <span className="text-[7px] font-black text-[#0c831f] uppercase tracking-tight">Delivered</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                    {/* Order Items */}
                    <div>
                        <p className="!text-[8px] font-black text-gray-400 tracking-[0.2em] mb-4 px-1 uppercase">Ordered items</p>
                            ...
                            {order.items.map((item, i) => (
                                <div key={i} className="flex items-center gap-4 py-4 px-1 hover:bg-gray-50/50 dark:hover:bg-white/5 transition-all">
                                    ...
                                    <div className="flex-1">
                                        <div className="!text-[10px] font-black text-gray-800 dark:text-gray-100 leading-tight tracking-tight">{item.name}</div>
                                        <div className="!text-[9px] text-gray-400 font-bold mt-1">Qty: {item.qty} • {item.price}</div>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    {/* Support Actions */}
                    <div>
                        <p className="!text-[8px] font-black text-gray-400 tracking-[0.2em] mb-4 px-1 uppercase">Need help with this order?</p>
                        <div className="border-t border-gray-100 dark:border-white/5">
                            <button onClick={() => navigate(`/orders/${order.id}/complaint`)} className="w-full py-5 px-1 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-white/5 active:scale-[0.98] transition-all group border-b border-gray-100 dark:border-white/5">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="!text-[10.5px] font-black text-gray-800 dark:text-gray-100 tracking-tight">Raise a complaint</div>
                                        <p className="!text-[8.5px] text-gray-400 font-bold tracking-tight">Issues with delivery or payment</p>
                                    </div>
                                </div>
                            ...
                            <button onClick={() => navigate(`/orders/${order.id}/return`)} className="w-full py-5 px-1 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-white/5 active:scale-[0.98] transition-all group border-b border-gray-100 dark:border-white/5">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="!text-[10.5px] font-black text-gray-800 dark:text-gray-100 tracking-tight">Return items</div>
                                        <p className="!text-[8.5px] text-gray-400 font-bold tracking-tight">Returning defective or wrong items</p>
                                    </div>
                                </div>
                            ...
                            <button onClick={() => navigate(`/orders/${order.id}/cancel`)} className="w-full py-5 px-1 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-white/5 active:scale-[0.98] transition-all group border-b border-gray-100 dark:border-white/5">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="!text-[10.5px] font-black text-gray-800 dark:text-gray-100 tracking-tight">Cancel order</div>
                                        <p className="!text-[8.5px] text-gray-400 font-bold tracking-tight">Cancel items before delivery</p>
                                    </div>
                                </div>
            ...
            {/* Bottom Floating Bar */}
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 dark:bg-black/60 backdrop-blur-md border-t border-gray-100 dark:border-white/5 shadow-[0_-4px_20px_rgba(0,0,0,0.03)] selection:bg-none">
