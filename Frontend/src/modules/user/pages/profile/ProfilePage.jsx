        ...
        <div className="min-h-screen bg-transparent dark:bg-black p-4 pt-6 md:p-8">
            <div className="max-w-2xl md:max-w-6xl mx-auto">
                ...
                <div className="md:grid md:grid-cols-3 md:gap-8">
                    ...
                    <div className="mb-8 md:mb-0 md:col-span-1 md:bg-white dark:md:bg-[#141414] md:rounded-2xl md:border md:border-gray-100 dark:md:border-white/5 md:p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-8 md:mt-10 py-6 md:py-8 border-y border-gray-50 dark:border-white/5 max-w-lg mx-auto md:max-w-none md:mx-0">
                    ...
                    <div className="md:col-span-2">
                        <div className="space-y-1 mb-6 md:mb-10 max-w-3xl mx-auto md:max-w-none md:mx-0">
                        ...
                        {/* Support Info */}
                        <div className="bg-[#eefaf1] rounded-2xl p-4 md:p-6 border border-[#0c831f]/10 text-center max-w-3xl mx-auto md:max-w-none md:mx-0">
