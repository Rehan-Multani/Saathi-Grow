...
const SavedAddressesPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-[#e8f5e9] to-[#ffffff] dark:from-[#141414] dark:to-[#141414] md:bg-white md:bg-none md:dark:bg-black pt-24 px-0 pb-24 md:p-8 md:pb-8 transition-colors duration-300">
