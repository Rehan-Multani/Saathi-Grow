                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <div className="!text-[13px] md:!text-lg font-black text-gray-900 dark:text-gray-100 tracking-tight leading-none mb-1">Order #{order.orderId || order._id.slice(-6).toUpperCase()}</div>
