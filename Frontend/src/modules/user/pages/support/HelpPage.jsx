        ...
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 pb-20">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex items-center gap-2 p-3 sticky top-0 bg-white/80 dark:bg-black/80 backdrop-blur-[10px] z-10 border-b border-gray-50 dark:border-white/5">
                    ...
                    <h1 className="!text-[11px] font-black text-gray-900 dark:text-gray-100 tracking-tight">Help & Support</h1>
                </div>
                ...
                <div className="mx-4 mt-2 mb-4 bg-[#0c831f] rounded-[20px] p-3 text-white shadow-lg shadow-green-500/10">
                    <div className="flex items-center gap-2 mb-3 text-left">
                        ...
                        <div>
                            <h2 className="!text-[10px] font-black leading-tight">24/7 Customer Care</h2>
                            <p className="!text-[7.5px] opacity-90 font-bold">We're here to help you anytime.</p>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-2 mt-3">
                        ...
                        <button
                            onClick={handleChat}
                            className="flex items-center justify-center gap-1.5 bg-white text-[#0c831f] p-1.5 rounded-lg transition-all hover:scale-[1.02] font-black !text-[8.5px] shadow-sm active:scale-95"
                        >
                ...
                <div className="px-4 mb-6">
                    <h3 className="!text-[8px] font-bold text-gray-400 mb-2 px-1">Common Questions</h3>
                ...
                <div className="mx-4 mb-10 bg-white dark:bg-[#121212] p-3.5 rounded-xl border border-dashed border-gray-200 dark:border-white/10 text-center">
                    ...
                    <h4 className="!text-[9.5px] font-bold text-gray-900 dark:text-gray-100 mb-0.5">Still need help?</h4>
                    <p className="!text-[7.5px] text-gray-500 mb-2.5 font-medium">Drop us an email anytime.</p>
                    <a
