...
const SecurityPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-[#e8f5e9] to-[#ffffff] dark:from-[#141414] dark:to-[#141414] md:bg-gray-50 dark:md:bg-black p-0 pt-0 relative overflow-hidden">
            <div className="max-w-2xl mx-auto">
                {/* Header */}
                <div className="flex items-center gap-3 mb-0 p-4 bg-gradient-to-r from-[#e8f5e9] to-[#ffffff] md:bg-none border-b border-gray-100 dark:border-white/5 md:border-none">
                    <button
                        onClick={() => {
