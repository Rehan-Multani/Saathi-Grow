        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                    <span className="px-3 py-1 bg-green-100 text-[#0c831f] text-xs font-bold rounded-full flex items-center gap-1">
                        <span className="w-2 h-2 rounded-full bg-[#0c831f] animate-pulse"></span>
                        Shop Open
                    </span>
                </div>
            </div>
                ...
                <div className="premium-card overflow-hidden">
                    ...
                    <div className="flex flex-col">
                        {recentOrders.map(order => (
                            <div key={order.id} className="p-4 border-b border-gray-50 last:border-0 hover:bg-gray-50 transition-all flex items-center gap-4 group cursor-pointer" onClick={() => navigate('/vendor/orders')}>
