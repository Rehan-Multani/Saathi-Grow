                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" readOnly value={formData.sku} className={`w-full px-4 py-2 border ${errors.sku ? 'border-red-500' : 'border-gray-200'} rounded-lg text-sm font-mono bg-gray-50 text-gray-500 cursor-not-allowed pr-10`} />
                                    ...
                                    {errors.sku && <p className="text-red-500 text-[10px] mt-1 font-bold">{errors.sku}</p>}
                                </div>
