                    ...
                    <table className="w-full text-left min-w-[900px]">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-xs font-bold text-gray-500 uppercase">Destination</th>
                                <th className="px-6 py-3 text-xs font-bold text-gray-500 uppercase">Courier</th>
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {filteredShipments.map(shipment => (
                                <tr key={shipment.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-sm font-medium text-gray-900">{shipment.courier}</td>
                                    <td className="px-6 py-4">
